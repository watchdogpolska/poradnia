...
CELERY_MONITOR_WORKER_CLEANUP_AFTER_SECONDS = 3600
CELERY_MONITOR_MIN_WORKERS = env.int("CELERY_MONITOR_MIN_WORKERS", 1)
# ### Uused settings
...
N8N_CASE_TAGS_WEBHOOK = env("N8N_CASE_TAGS_WEBHOOK", default="")
N8N_CASE_TAGS_WEBHOOK_TOKEN = env("N8N_CASE_TAGS_WEBHOOK_TOKEN", default="")
