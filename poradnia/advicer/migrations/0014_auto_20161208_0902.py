...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('advicer', '0013_auto_20151218_0035'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='area',
            options={'verbose_name': 'Problem regarding the right to information', 'verbose_name_plural': 'Problems regarding the right to information'},
        ),
        migrations.AlterModelOptions(
            name='issue',
            options={'verbose_name': 'The thematic scope of the request', 'verbose_name_plural': 'Thematic scopes of requests'},
        ),
        migrations.AlterModelOptions(
            name='personkind',
            options={'verbose_name': 'Type of person who reporting the advice', 'verbose_name_plural': 'Types of people who report to for advice'},
        ),
        migrations.AddField(
            model_name='advice',
            name='helped',
