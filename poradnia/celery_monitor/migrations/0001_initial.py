    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("status", models.CharField(choices=[("ok", "OK"), ("warn", "Warning"), ("fail", "Failure")], default="ok", max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("status", models.CharField(choices=[("ok", "OK"), ("warn", "Warning"), ("crit", "Critical")], default="ok", max_length=10)),
            ...
            options={"ordering": ["queue_name"], "unique_together": {("vhost", "queue_name")}},
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("status", models.CharField(choices=[("ok", "OK"), ("stale", "Stale"), ("missing", "Missing")], default="ok", max_length=10)),
                ("last_seen_at", models.DateTimeField(default=django.utils.timezone.now)),
                ("last_task_id", models.CharField(blank=True, default="", max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("severity", models.CharField(choices=[("warn", "Warning"), ("crit", "Critical")], max_length=10)),
