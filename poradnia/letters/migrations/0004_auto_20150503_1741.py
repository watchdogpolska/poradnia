...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='letter',
            name='accept',
            field=model_utils.fields.MonitorField(default=django.utils.timezone.now, when=set([b'done']), verbose_name='Accepted on', monitor=b'status'),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='letter',
        ...
        migrations.AlterField(
            model_name='letter',
            name='genre',
            field=models.CharField(default=b'comment', max_length=20, choices=[(b'mail', b'mail'), (b'comment', b'comment')]),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='letter',
