...
urlpatterns = [
    ...
    url(
        regex=r"^~przekieruj/$", view=views.UserRedirectView.as_view(), name="redirect"
    ),
    ...
    url(regex=r"^~aktualizuj/$", view=views.UserUpdateView.as_view(), name="update"),
    # URL pattern for the ProfileUpdateView
    url(regex=r"^~profil/$", view=views.ProfileUpdateView.as_view(), name="profile"),
    url(
