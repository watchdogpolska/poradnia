...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('task_type', models.CharField(choices=[('Fetch articles', 'Fetch Articles'), ('Index articles', 'Index Articles'), ('Generate embeddings', 'Generate Embeddings'), ('Full reindexing', 'Reindex All'), ('Cleanup orphaned records', 'Cleanup Orphaned')], max_length=50, verbose_name='Task type')),
                ('status', models.CharField(choices=[('Running', 'Running'), ('Success', 'Success'), ('Failed', 'Failed'), ('Partial success', 'Partial')], default='running', max_length=20, verbose_name='Status')),
                ...
                ('sentry_event_id', models.CharField(blank=True, max_length=100, null=True, verbose_name='Sentry event ID')),
                ('log_message', models.TextField(blank=True, verbose_name='Log message')),
                ('command_args', models.JSONField(default=dict, verbose_name='Command arguments')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case_id', models.PositiveIntegerField(blank=True, null=True, verbose_name='Case ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='articles', to='knowledge.contentsource', verbose_name='Source')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created at')),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chunks', to='knowledge.article', verbose_name='Article')),
            ],
            options={
