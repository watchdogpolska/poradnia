...
urlpatterns = [
    ...
    path('sprawa-<int:pk>/uprawnienia/', views.UserPermissionCreateView.as_view(),
        name="permission_add"),
    path('sprawa-<int:pk>/uprawnienia-<username>)/',
        views.UserPermissionUpdateView.as_view(),
        name="permission_update"),
    path('sprawa-<int:pk>/uprawnienia-<username>/~remove',
        views.UserPermissionRemoveView.as_view(),
        name="permission_remove"),
    path('sprawa-<int:pk>/uprawnienia/przyznaj/',
        views.CaseGroupPermissionView.as_view(),
        name="permission_grant"),
    path('sprawa-<int:pk>/', views.CaseDetailView.as_view(),
        name="detail"),
    path('~autocomplete', views.CaseAutocomplete.as_view(),
        name="autocomplete"),
]
